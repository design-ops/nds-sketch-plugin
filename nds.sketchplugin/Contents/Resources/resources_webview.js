...
*/
window.showSelectLibrary = function (libraryData) {
  console.log("showSelectLibrary", libraryData);
  var body = document.querySelector("#content");
  var outer = document.querySelector("template#chooseLibrary").content.cloneNode(true);
  var entryTemplate = document.querySelector("template#libraryOption").content;
...
selectLibrary = function selectLibrary(node) {
  var id = node.attributes.libraryId;
